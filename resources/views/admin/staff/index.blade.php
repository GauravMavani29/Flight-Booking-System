    ...
    <div class="row align-items-center">
        <div class="mb-4 border-0">
            <div
                ...
                <h3 class="fw-bold mb-0">All User</h3>
                <a href={{ route('admin.staff.create') }} class="btn btn-primary btn-set-task w-sm-100 py-2 px-5"><i
                        class="icofont-plus-circle me-2 fs-6"></i>Add New Staff</a>
            </div>
        </div>
    </div> <!-- Row end  -->
                                ...
                                <tr id="row-{{ $user->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm confirm-delete"
                                            data-href="{{ route('admin.staff.destroy', $user->id) }}"><i
