    ...
    <div class="row align-items-center">
        <div class="mb-4 border-0">
            <div
                ...
                <a href={{ route('admin.role.create') }} class="btn btn-primary btn-set-task w-sm-100 py-2 px-5"><i
                        class="icofont-plus-circle me-2 fs-6"></i>Add New Role</a>
            </div>
        </div>
    </div> <!-- Row end  -->
                                ...
                                <tr id="row-{{ $role->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm confirm-delete"
                                            data-href="{{ route('admin.role.destroy', $role->id) }}"><i
